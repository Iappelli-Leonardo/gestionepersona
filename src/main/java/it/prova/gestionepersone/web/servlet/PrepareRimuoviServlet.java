...
public class PrepareRimuoviServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			request.setAttribute("delete_persona_attr", MyServiceFactory.getPersonaServiceInstance()
		...
		request.getRequestDispatcher("/persona/rimuovi.jsp").forward(request, response);
